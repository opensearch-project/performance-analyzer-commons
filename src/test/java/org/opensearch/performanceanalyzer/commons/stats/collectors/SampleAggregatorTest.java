...
package org.opensearch.performanceanalyzer.commons.metrics.stats.collectors;
...
import org.opensearch.performanceanalyzer.commons.metrics.stats.measurements.MeasurementSetTestHelper;
import org.opensearch.performanceanalyzer.commons.stats.StatsReporter;
...
import org.opensearch.performanceanalyzer.commons.stats.format.DefaultFormatter;
...
public class SampleAggregatorTest {
    ...
    public void updateStat() {
        ...
        StatsReporter reporter = new StatsReporter(Collections.singletonList(sampleAggregator));
